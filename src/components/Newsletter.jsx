    ...
    <>
      <section id="newsletter" className="bg-softBlue">
        <div className="max-w-lg mx-auto py-24">
          ...
          <Heading className={`px-3 text-3xl text-white md:text-4xl`}>
...
// px-3 mb-6 text-3xl font-semibold text-center text-white md:text-4xl
// mb-6 text-4xl font-semibold text-center
